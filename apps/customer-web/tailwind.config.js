  ...
  theme: {
    extend: {
      colors: {
        ...
        // the accent, `action-strong` is orange as text, and `action-fill` is
        // the plate that carries a white label — see the token comments in
        // index.css for which does which in dark mode.
