...
/**
 * What the browser paints for itself — the mobile address bar, mainly.
 *
 * `--surface`, because the sticky header is the first thing under that bar and
 * a toolbar in a different colour from the header directly below it reads as a
 * rendering fault rather than as chrome.
 */
...
export function ThemeProvider({ children }: { children: ReactNode }): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    if (meta !== null) meta.setAttribute('content', THEME_COLOR[resolved]);
  }, [resolved]);
